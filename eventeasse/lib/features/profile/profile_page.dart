                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: const [
                                  ...
                                  SizedBox(height: 12),
                                  Text('"Aplikasi ini sangat membantu saya menemukan event menarik!"', style: TextStyle(fontSize: 15, color: Color(0xFF1B5E20))),
                                  SizedBox(height: 8),
                                  Text('"Tampilan modern dan mudah digunakan."', style: TextStyle(fontSize: 15, color: Color(0xFF1B5E20))),
                                  SizedBox(height: 8),
                                  Text('"Semoga ke depannya makin banyak fitur baru."', style: TextStyle(fontSize: 15, color: Color(0xFF1B5E20))),
                                ],
                              ),
                            ),
                          ],
